	...
	public function getProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			if($customer_group_id == 2) {
				$res = $this->db->query("SELECT price_3 FROM " . DB_PREFIX . "prices WHERE product_id = " . $product_id);
			...
			if($customer_group_id == 3) {
				$res = $this->db->query("SELECT price_4 FROM " . DB_PREFIX . "prices WHERE product_id = " . $product_id);
