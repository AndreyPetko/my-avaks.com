			...
			<div class="pull-right">
				<div class="btn-group">
					...
					<ul class="dropdown-menu pull-right">
						<?php if ($logged) { ?>
						<li><a href="<?php echo $account; ?>"><i class="fa fa-area-chart dropdown-menu-icon"></i>&nbsp;&nbsp;<?php echo $text_account; ?></a></li>
						<li><a href="<?php echo $order; ?>"><i class="fa fa-history dropdown-menu-icon"></i>&nbsp;&nbsp;<?php echo $text_order; ?></a></li>
						<li><a href="<?php echo $transaction; ?>"><i class="fa fa-credit-card dropdown-menu-icon"></i>&nbsp;&nbsp;<?php echo $text_transaction; ?></a></li>
						<li><a href="<?php echo $download; ?>"><i class="fa fa-download dropdown-menu-icon"></i>&nbsp;&nbsp;<?php echo $text_download; ?></a></li>
						<li><a href="<?php echo $logout; ?>"><i class="fa fa-sign-out dropdown-menu-icon"></i>&nbsp;&nbsp;<?php echo $text_logout; ?></a></li>
						<?php } else { ?>
						<li><a href="<?php echo $login; ?>"><i class="fa fa-unlock-alt dropdown-menu-icon"></i>&nbsp;&nbsp;<?php echo $text_login; ?></a></li>
						<li><a href="<?php echo $register; ?>"><i class="fa fa-pencil dropdown-menu-icon"></i>&nbsp;&nbsp;<?php echo $text_register; ?></a></li>
						<?php } ?>
					</ul>
				</div>
			</div>
