  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group required">
        ...
        <input type="text" name="address_1" value="" placeholder="Адреса, індекс" id="input-payment-address-1" class="form-control" />
      </div>
<!--       <div class="form-group">
...
<div class="buttons clearfix">
  <div class="pull-right"><?php echo $text_agree; ?> &nbsp;
    ...
    <input type="button" value="Продовжити" id="button-register" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary" />
  </div>
</div>
<?php } else { ?>
<div class="buttons clearfix">
