  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-firstname">Прізвище, Ім'я</label>
        <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="Прізвище, Ім'я" id="input-payment-firstname" class="form-control" />
      </div>
     <!--  <div class="form-group required">
  ...
  <div class="col-sm-6">
    <fieldset id="address">
     ...
     <!--  <div class="form-group">
      ...
      <div class="form-group required">
        <label class="control-label" for="input-payment-address-1">Адреса, індекс</label>
...
<div class="buttons">
  <div class="pull-right">
    <input type="button" value="Продовжити" id="button-guest" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary" />
  </div>
</div>
