...
class ControllerInformationNews extends Controller {
	public function index() {
		...
		foreach ($all_news as $news) {
			$data['all_news'][] = array (
				...
				'image'			=> $this->model_tool_xdsimage->resize($news['image'], 220, 155),
	...
	public function news() {
		...
		$this->document->addScript('catalog/view/javascript/share/social-likes.min.js');
		$this->document->addStyle('catalog/view/javascript/share/social-likes_birman.css');
		...
		if ($news) {
			...
			$data['image'] = $this->model_tool_xdsimage->resize2($news['image'], 1160, 400);
			
			$data['original_image'] = $this->model_tool_xdsimage->original_size($news['image']);
