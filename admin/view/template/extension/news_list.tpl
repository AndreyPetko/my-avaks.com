  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-newspaper-o"></i> <?php echo $text_list; ?></h3>
      </div>
			  ...
			  <tbody>
				<?php if ($all_news) { ?>
				  ...
				  <tr>
					...
					<td class="text-right"><a href="<?php echo $news['edit']; ?>" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="<?php echo $text_edit; ?>"><i class="fa fa-pencil"></i></a></td>
				  </tr>
				  <?php } ?>
				<?php } else { ?>
				  <tr>
	...
	<div style="text-align:center; color:#222222;">Advance News System v3.0.1 by <a target="_blank" href="http://www.marketinsg.com">MarketInSG</a><br>Modified and translated by <a target="_blank" href="http://xds.by">XDS</a></div>
  </div>
</div>
<?php echo $footer; ?>