    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
		  ...
		  <div class="form-group">
			<label class="col-sm-3 control-label" for="track_no_email_notify">Уведомлять покупателя по E-mail:</label>
			<div class="col-sm-7">
		  ...
		  <div class="form-group">
			<label class="col-sm-3 control-label" for="track_no_sms_notify">Уведомлять покупателя по SMS:</label>
			<div class="col-sm-7">
