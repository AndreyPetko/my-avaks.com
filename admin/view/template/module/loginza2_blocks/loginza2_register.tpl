...
<div class="content register_loginza2_table_content">
			#loginza2_label#
			
		<div align=center class="register_loginza2_table_links">
		<iframe src="https://loginza.ru/api/widget?overlay=loginza<?php 
		if( $loginza2_default ) 
		echo '&provider='.$loginza2_default;  
		?>&token_url=#domain#<?php 
		echo urlencode( $loginza2_shop_folder.'/index.php?route=register/loginza2'); 
...
<div class="content register_loginza2_button_content" style="min-height: 0px;">	
			#loginza2_label#	
			<div  class="register_loginza2_button_links">
				<a class="<?php echo $classname; ?>" href="https://loginza.ru/api/widget?token_url=#domain#<?php echo urlencode($loginza2_shop_folder.'/index.php?route=register/loginza2'); 
...
<div class="content register_loginza2_icons_content" style="min-height: 0px;">

				#loginza2_label#
		  
		  
		  <div class="register_loginza2_icons_links">
