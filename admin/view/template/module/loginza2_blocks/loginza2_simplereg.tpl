...
<?php if( $loginza2_format == 'table' ) { ?>
	<div class="simplecheckout-block-heading simplereg_loginza2_table_content">	
		#loginza2_label#
		<div align=center class="simplereg_loginza2_table_links">
...
<?php if( $loginza2_format == 'button' ) { ?>
	<div class="simplecheckout-block-heading simplereg_loginza2_button_content">
			#loginza2_label#	
			<div  class="simplereg_loginza2_button_links">
...
<?php /* ==================== Маленькие иконки ============== */ ?>
		  ...
		  ?>
		  <div class="simplecheckout-block-heading simplereg_loginza2_icons_content">
			#loginza2_label#
		  
		  
		  <div class="simplereg_loginza2_icons_links">
