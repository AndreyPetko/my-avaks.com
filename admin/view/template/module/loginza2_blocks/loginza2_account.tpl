...
<div class="content account_loginza2_table_content">
			#loginza2_label#
			
		<div align=center class="account_loginza2_table_links">
...
<div class="content account_loginza2_button_content" style="min-height: 0px;">	
			#loginza2_label#	
			<div  class="account_loginza2_button_links">
				<a class="<?php echo $classname; ?>" href="https://loginza.ru/api/widget?token_url=#domain#<?php echo urlencode($loginza2_shop_folder.'/index.php?route=account/loginza2'); 
...
<div class="content account_loginza2_icons_content" style="min-height: 0px;">

				#loginza2_label#
		  
		  
		  <div class="account_loginza2_icons_links">
