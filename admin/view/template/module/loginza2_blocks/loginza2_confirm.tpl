...
<div id="loginzabox" class="" style="display: block; padding-bottom: 57px; padding: 15px; top: 50px; left: 368px; position: fixed; width: 540px; height: #divframe_height#px;"
>
