...
<div class="content checkout_loginza2_table_content">
			#loginza2_label#
		<div align=center class="checkout_loginza2_table_links">
...
<div class="content checkout_loginza2_button_content">		
				#loginza2_label#
			<div  class="checkout_loginza2_button_links">
				<a class="<?php echo $classname; ?>"  href="https://loginza.ru/api/widget?token_url=#domain#<?php echo urlencode('/index.php?route=account/loginza2'); 
...
<div class="content checkout_loginza2_icons_content">
			
				#loginza2_label#
			
		  <div class="checkout_loginza2_icons_links">
		  <?php foreach( $res_socnets as $row ) { ?>
		  
			<a class="<?php echo $classname; ?>" target=_blank  class="loginza" href="https://loginza.ru/api/widget?token_url=#domain#<?php 
			echo urlencode('/index.php?route=account/loginza2'); 
