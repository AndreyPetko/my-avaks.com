...
class Modelmoduleloginza2 extends Model 
{
	...
	public function makeCode($data, $socnets)
	{
		...
		{
			$data['loginza2_simple_code'] = '';
			$data['loginza2_account_top_code'] = '';
			$data['loginza2_account_bottom_code'] = '';
			$data['loginza2_checkout_top_code'] = '';
			$data['loginza2_checkout_bottom_code'] = '';
		...
		$template_data = array();
		$template_data['providers'] = $providers;
		$template_data['res_socnets'] = $res_socnets;
		$template_data['loginza2_default'] = $data['loginza2_default'];
		$template_data['loginza2_format'] = $data['loginza2_format'];
		$template_data['loginza2_label'] = $data['loginza2_label'];
		$template_data['loginza2_showtype'] = $data['loginza2_showtype'];
		
		
		if( $data['loginza2_showtype']=='window' )
		{
			$template_data['classname'] = 'loginza';	
		}
		else
		{
		...
		$template_data['loginza2_shop_folder'] = $this->config->get('loginza2_shop_folder');
		
		if( $template_data['loginza2_shop_folder'] )
		$template_data['loginza2_shop_folder'] = '/'.$template_data['loginza2_shop_folder'];
		
		
		$data['loginza2_simplereg_code'] = $this->load->view('module/loginza2_blocks/loginza2_simplereg.tpl', $template_data);
		$data['loginza2_simple_code']    = $this->load->view('module/loginza2_blocks/loginza2_simple.tpl', $template_data);

		$data['loginza2_account_code']   = $this->load->view('module/loginza2_blocks/loginza2_account.tpl', $template_data);
		
		$data['loginza2_register_code']   = $this->load->view('module/loginza2_blocks/loginza2_register.tpl', $template_data);
		
		$data['loginza2_checkout_code']  = $this->load->view('module/loginza2_blocks/loginza2_checkout.tpl', $template_data);
		$data['loginza2_confirm_block'] = $this->load->view('module/loginza2_blocks/loginza2_confirm.tpl', $template_data);
		
		$template_data['loginza2_format'] = 'table';
		
		$data['loginza2_simplereg_code_table'] = $this->load->view('module/loginza2_blocks/loginza2_simplereg.tpl', $template_data);
		$data['loginza2_simple_code_table']    = $this->load->view('module/loginza2_blocks/loginza2_simple.tpl', $template_data);
		$data['loginza2_account_code_table']   = $this->load->view('module/loginza2_blocks/loginza2_account.tpl', $template_data);
		
		$data['loginza2_register_code_table']   = $this->load->view('module/loginza2_blocks/loginza2_register.tpl', $template_data);
		
		$data['loginza2_checkout_code_table']  = $this->load->view('module/loginza2_blocks/loginza2_checkout.tpl', $template_data);
		$data['loginza2_confirm_block_table'] = $this->load->view('module/loginza2_blocks/loginza2_confirm.tpl', $template_data);
		
		$template_data['loginza2_format'] = 'button';
		
		$data['loginza2_simplereg_code_button'] = $this->load->view('module/loginza2_blocks/loginza2_simplereg.tpl', $template_data);
		$data['loginza2_simple_code_button']    = $this->load->view('module/loginza2_blocks/loginza2_simple.tpl', $template_data);
		$data['loginza2_account_code_button']   = $this->load->view('module/loginza2_blocks/loginza2_account.tpl', $template_data);
		
		$data['loginza2_register_code_button']   = $this->load->view('module/loginza2_blocks/loginza2_register.tpl', $template_data);
		
		$data['loginza2_checkout_code_button']  = $this->load->view('module/loginza2_blocks/loginza2_checkout.tpl', $template_data);
		$data['loginza2_confirm_block_button'] = $this->load->view('module/loginza2_blocks/loginza2_confirm.tpl', $template_data);
		
		$template_data['loginza2_format'] = 'icons';
		
		$data['loginza2_simplereg_code_icons'] = $this->load->view('module/loginza2_blocks/loginza2_simplereg.tpl', $template_data);
		$data['loginza2_simple_code_icons']    = $this->load->view('module/loginza2_blocks/loginza2_simple.tpl', $template_data);
		$data['loginza2_account_code_icons']   = $this->load->view('module/loginza2_blocks/loginza2_account.tpl', $template_data);
		
		$data['loginza2_register_code_icons']   = $this->load->view('module/loginza2_blocks/loginza2_register.tpl', $template_data);
		
		$data['loginza2_checkout_code_icons']  = $this->load->view('module/loginza2_blocks/loginza2_checkout.tpl', $template_data);
		$data['loginza2_confirm_block_icons'] = $this->load->view('module/loginza2_blocks/loginza2_confirm.tpl', $template_data);
	...
	public function showData()
	{
		...
		{ 
			...
			if( !empty($customer['loginza2_data']) )
			{
				...
				$text = '<div class="form-group"><label class="col-sm-2 control-label" for="input-safe">Loginza:</label><div class="col-sm-10">'.$loginza2_data.'</div></div>';
